...
- Read the instructions under `Multiple choice question`
...
... that we think will be fixed soon

- Currently learnr gives a warning if the exercise code chunk produces an invisible result, e.g. code chunk makes an assignment instead of outputting a result

- If code in the exercise chunk is invalid
